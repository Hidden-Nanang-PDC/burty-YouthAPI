 ...
 * - JpaSpecificationExecutor 를 상속받아 동적 검색 지원
 * - 센터 테이블에서 중복 없는 시도/시군구 코드를 추출하는 커스텀 쿼리 포함
 */
public interface YouthCenterRepository
        extends JpaRepository<YouthCenter, String>,
        JpaSpecificationExecutor<YouthCenter> {
